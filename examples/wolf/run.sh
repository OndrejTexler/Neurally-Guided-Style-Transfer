...
../../styletransfer --style style.jpg --neural_result neuralGatys.jpg --out_path result_patch_based_max_mp_1.jpg --patch_based_max_mp 1

# Patch-Based synthesis will run on resolution not higher than 4Mpx (the result will be then upsampled to 6000x4000)
../../styletransfer --style style.jpg --neural_result neuralGatys.jpg --out_path result_patch_based_max_mp_4.jpg --patch_based_max_mp 4
...
../../styletransfer --style style.jpg --neural_result neuralGatys.jpg --out_path result_patch_based_max_mp_4_cpu.jpg --patch_based_max_mp 4 --patch_based_backend "CPU"

# Patch-Based synthesis will run on resolution not higher than 1Mpx (the result will be then upsampled to 6000x4000)
# Also, the result will resemble target photograph's colors.
# This might or might not lead to pleasing results - just try it :-)
../../styletransfer --style style.jpg --neural_result neuralGatys.jpg --out_path result_patch_based_max_mp_1_recolor_by_target.jpg --patch_based_max_mp 1 --target target.jpg --recolor_by_target
...
../../styletransfer --style style.jpg --neural_result neuralGatys.jpg --out_path result_patch_based_max_mp_1_guide_by_target.jpg --patch_based_max_mp 1 --target target.jpg --guide_by_target
